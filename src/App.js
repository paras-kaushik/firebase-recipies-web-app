...
function App() {
  ...
  async function fetchUsers() {
    ...
    try {
      ...
      //   return { ...data, id };
      // });
      response.docs.forEach((recipeDoc)=> console.log(recipeDoc));
    } catch (error) {
      console.error(error.message);
      throw error;
    }
  ...
  const callFirebaseFunction = event => {
    ...
    const callableReturnMessage = firebase.functions().httpsCallable('addAdminRole');
    const myEmail=(document.getElementById('email-holder').value)
    callableReturnMessage({email:myEmail}).then((result) => {
      console.log(result.data.output);
      console.log('ho sakta hai ki sapne soch ho')
    }).catch((error) => {
  ...
  return (
    <div className="App">
      <div>
        <input type="text" name="email-holder" id="email-holder" />
